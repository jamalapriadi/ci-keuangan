...
<form name="form" method="post" action="<?php echo base_url();?>index.php/admin">
...
<?php
	if($data->num_rows()>0){
    	...
    	<tr>
            ...
            <td align="center" ><?php echo $db['nama_client']; ?></td>
            <td align="center" width="80" ><?php echo $db['kode_rek']; ?></td>
            <td ><?php echo $nama_rek; ?></td>
			<td align="center" width="80" ><?php echo $db['harga']; ?></td>            
            <td align="center" width="80" ><?php echo $db['ppn']; ?></td>
			<td align="center" width="80" ><?php echo $db['total']; ?></td>
            ...
            <a href="<?php echo base_url();?>index.php/admin/hapus/<?php echo $db['no_po'];?>"
            onClick="return confirm('Anda yakin ingin menghapus Order PO ini?')">
