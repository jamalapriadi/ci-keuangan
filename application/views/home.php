...
<head>
<title>Selamat Datang di Sistem Managemen Keuangan</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<meta name="robots" content="index, follow">
<meta http-equiv="Copyright" content="Ahmad Kurosaki">
<meta name="author" content="Ahmad Kurosaki">
...
<body onLoad="goforit()">
<div class="header" style="height:85px;background:white;padding:2px;margin:0;">
		<div style="float:left; padding:0px; margin:0px;">
        <img src='<?php echo base_url();?>asset/images/logo/logo-neonlite.png' style="padding:0; margin:0;" width="85" height="71">
        </div>
      ...
      <p><?php echo $alamat_instansi1;?></p>
      <p><?php echo $alamat_instansi2;?></p>
	  </div>
